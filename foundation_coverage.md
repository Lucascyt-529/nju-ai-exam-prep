...
| 命令行参数、错误码、输出目录 | 四道`integrated_tasks/`与模拟卷1 | 已验证于完整程序 | 尚缺独立基础练习 |
...
1. 独立的命令行完整程序骨架：参数、路径、错误码、`main()`与原子化小函数；
2. mini-batch索引、可复现随机数与训练循环数据流；
3. 异常值诊断和仅用训练集拟合的稳健处理边界；
4. 类别词表JSON与NumPy模型包组合成一份完整混合特征预测任务；
5. 学习者完成基础starter后，建立真正的个人掌握证据和错题记录。
